            ...
            return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 27:
                    _context.next = 29;
                    return Promise.resolve().then(function () { return require('./clientSideSmartOrderRouter-ff770074.cjs'); });
...
function usePermitAllowance(token, spender) {
  ...
  var allowanceProvider = React.useMemo(function () {
    return provider && new permit2Sdk.AllowanceProvider(provider, permit2Sdk.PERMIT2_ADDRESS);
  }, [provider]);
...
function useTokenAllowance(token, owner, spender) {
  ...
  return React.useMemo(function () {
    var tokenAllowance = token && result && sdkCore.CurrencyAmount.fromRawAmount(token, result.toString());
    return {
...
function usePermit$1(amount, spender) {
  ...
  var _useState = React.useState(permitAllowance === null || permitAllowance === void 0 ? void 0 : permitAllowance.amount),
      _useState2 = _slicedToArray__default["default"](_useState, 2),
  ...
  var _useState5 = React.useState(SyncState.SYNCED),
  ...
  var hasPendingApproval = Boolean(usePendingApproval(token, permit2Sdk.PERMIT2_ADDRESS));
  React.useEffect(function () {
...
function useComputeSwapInfo(routerUrl) {
  ...
  var permit = usePermit$1(permit2Enabled ? maximumAmountIn : undefined, permit2Enabled && chainId ? universalRouterSdk.UNIVERSAL_ROUTER_ADDRESS(chainId) : undefined);
  return React.useMemo(function () {
    var _ref2;
...
}), _defineProperty__default["default"](_DEFAULT_SWAP_INFO, "permit", {
  state: PermitState$1.INVALID
...
function PermitButton(_ref) {
  ...
  var onClick = React.useCallback( /*#__PURE__*/_asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2() {
    return _regeneratorRuntime__default["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
...
function SwapButton(_ref) {
  ...
  if (permit2Enabled) {
    if (!disabled && permit.state === PermitState$1.PERMIT_NEEDED) {
      return /*#__PURE__*/React__default["default"].createElement(PermitButton, _extends__default["default"]({
        color: color,
        onSubmit: onSubmit
      }, permit));
    }
